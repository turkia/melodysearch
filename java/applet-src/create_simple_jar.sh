...
javac MidiSynth.java SimpleSearchApplet.java
jar cfv SimpleSearchApplet.jar *.class

# Step 2: Sign the archive. 

echo " "
echo "Sign the archive:"
jarsigner -verbose -keystore $KEYSTORE -storepass $STOREPASS SimpleSearchApplet.jar CBrahms

# Step 3: Show the contents of the signed archive. 

echo " "
echo "Contents of the archive are: "
jar tvf SimpleSearchApplet.jar
...
cp SimpleSearchApplet.jar ../html
rm *.class
